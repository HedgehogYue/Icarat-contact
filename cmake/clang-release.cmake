...
# set compiler
set(CMAKE_C_COMPILER "clang" CACHE STRING "gcc compiler" FORCE)
set(CMAKE_CXX_COMPILER "clang++" CACHE STRING "gcc compiler" FORCE)

# set install library as serial mode
set(CACHE_MPI OFF CACHE BOOL "mpi flag" FORCE)

# set compiler flags
set(CACHE_FLAGS -O3 -Xpreprocessor -fopenmp -DEIGEN_NO_DEBUG -DEIGEN_INITIALIZE_MATRICES_BY_ZERO -I/usr/local/opt/libomp/include CACHE STRING "flag" FORCE)

# set link flags
set(CACHE_LDFLAGS -L/usr/local/opt/libomp/lib -lomp CACHE STRING "link option" FORCE)
