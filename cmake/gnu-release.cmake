...
# set compiler
set(CMAKE_C_COMPILER "gcc-13" CACHE STRING "gcc compiler" FORCE)
set(CMAKE_CXX_COMPILER "g++-13" CACHE STRING "gcc compiler" FORCE)

# set install library as serial mode
set(CACHE_MPI OFF CACHE BOOL "mpi flag" FORCE)

# set compiler flags
set(CACHE_FLAGS -O3 -fopenmp -DEIGEN_NO_DEBUG -DEIGEN_INITIALIZE_MATRICES_BY_ZERO CACHE STRING "flag" FORCE)

# set link flags
set(CACHE_LDFLAGS -fopenmp CACHE STRING "link option" FORCE)
